    ...
    <div className="md:pt-40 *:pt-20">
        ...
        >
          <form onSubmit={handleSubmit} className="text-base text-white">
                ...
                >
                  <input
                    ...
                    className="w-full bg-transparent text-sm text-white 
                               placeholder-white/80 focus:outline-0"
                    required
                  />
                </div>
              </div>
            ...
            <div className="mb-4 p-2">
              <div className="relative flex w-full max-w-md items-center gap-2 
                              rounded-half border border-white/20 bg-gradient-to-br 
                              from-white/20 to-white/5 py-1.5 pl-6 pr-1.5"
              >
                <textarea
                  id="message"
            ...
            <div className="text-center px-6 py-2 text-white transition-colors">
              <ButtonWrapper
